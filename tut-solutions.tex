...
\begin{enumerate}
	...
	\begin{soln}
		...
		\begin{align*} 
			...
			&= \dfrac{1}{4}\int_{|z| = 1}^{} \dfrac{(z^3 + z^{-3})^2}{5 - 2(z^2 - z^{-2})}\dfrac{1}{\iota z} {\mathrm{d}}z\\
	...
	\begin{soln}
		...
		The singularities of $f$ are $0, \pm 2\iota.$ Being only finitely, they are all isolated. Moreover, all of them are poles. (Since none of them is a root of the numerator, they are not removable.) All of these lie within the given circle. Thus, the given integral is just 
		\begin{equation*} 
	...
	\begin{soln}
		...
		\end{equation*}
		Its poles are $-1 \pm \iota, \pm 2\iota.$ Thus, if we take $R > 43,$ then all the poles \textbf{in the upper half plane} are enclosed in the following contour.
	...
	(Showing this is not too tough, you may ask me if you are interested and don't get it on your own.)
	%
	%
	...
	\begin{soln}
		...
		Consider the complex number $a_0 \in \mathbb{C}.$ By Cassorati-Weierstrass, there exists a sequence $z_n \to 0$ such that
		\begin{equation*} 
